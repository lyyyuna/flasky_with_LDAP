...
def post(id):
    ...
    pagination = post.comments.order_by(Comment.timestamp.asc()).pagination(page, per_page=current_app.config['FLASKY_COMMENTS_PER_PAGE'], error_out=False)
